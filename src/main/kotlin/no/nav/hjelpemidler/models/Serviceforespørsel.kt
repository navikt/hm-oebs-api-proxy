...
data class Serviceforespørsel(
    ...
    data class Artikkel(override val hmsnr: String, override val antall: String, val shippinginstructions: String = "Tester notat til 5.17") : no.nav.hjelpemidler.models.Artikkel
}
